...
senator_consistency <- mutate( senator_consistency, cons_D = sum(group_by(name_votes,print_name)$tally_code) )


senator_consistency

#senator_consistency_test = filter()



for( name in senator_consistency$print_name ){
  #print(name)
  local_senator_consistency = filter(group_by(name_votes,print_name), print_name == name)
  
  #local_senator_consistency
  
  #local_senator_consistency
  #senator_consistency$cons_D
}
...
#group_by(name_votes,print_name) %>% summarise()
