...
```{r plot party support, echo=FALSE, include=FALSE}
...
party_support_differenceD %>% ggplot() + geom_point( aes( x=as.factor(rowid), y=D), color="blue") + geom_point( aes( x=as.factor(rowid), y=R), color="red") + xlab("Vote") + ylab("Party Support")
...
region_support_differenceNE %>% ggplot() + geom_point( aes( x=as.factor(rowid), y=Northeast), color="blue") + geom_point( aes(x=as.factor(rowid), y=South), color="red") + geom_point( aes(as.factor(rowid), y=Midwest), color="gold") + geom_point( aes(as.factor(rowid), y=West), color="green") + xlab("Vote") + ylab("Region Support") + theme(axis.text.x = element_blank())

region_support_differenceS %>% ggplot() + geom_point( aes( x=as.factor(rowid), y=Northeast), color="blue") + geom_point( aes(x=as.factor(rowid), y=South), color="red") + geom_point( aes(as.factor(rowid), y=Midwest), color="gold") + geom_point( aes(as.factor(rowid), y=West), color="green") + xlab("Vote") + ylab("Region Support") + theme(axis.text.x = element_blank())

region_support_differenceW %>% ggplot() + geom_point( aes( x=as.factor(rowid), y=Northeast), color="blue") + geom_point( aes(x=as.factor(rowid), y=South), color="red") + geom_point( aes(as.factor(rowid), y=Midwest), color="gold") + geom_point( aes(as.factor(rowid), y=West), color="green") + xlab("Vote") + ylab("Region Support") + theme(axis.text.x = element_blank())

region_support_differenceMW %>% ggplot() + geom_point( aes( x=as.factor(rowid), y=Northeast), color="blue") + geom_point( aes(x=as.factor(rowid), y=South), color="red") + geom_point( aes(as.factor(rowid), y=Midwest), color="gold") + geom_point( aes(as.factor(rowid), y=West), color="green") + xlab("Vote") + ylab("Region Support") + theme(axis.text.x = element_blank())
